...
// TDR TLV编码方式type id
#define TDR_TYPE_ID_VARINTS          0
#define TDR_TYPE_ID_INT8             1
#define TDR_TYPE_ID_INT16            2
#define TDR_TYPE_ID_INT32            3
#define TDR_TYPE_ID_INT64            4
#define TDR_TYPE_ID_LENGTH_DELIMITED 5
